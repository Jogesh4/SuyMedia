                                ...
                                <table class="table table-borderless datatable dataTable-table text-center">
                                      ...
                                      <tr>
                                        ...
                                        @if($order->order_status == '0')
                                           <td><span class="badge text-secondary mt-2">Pending</span></td>
                                        @endif
                                        @if($order->order_status == '1')
                                           <td><span class="badge text-success mt-2">Confirmed</span></td>
                                        @endif
                                        @if($order->order_status == '9')
                                           <td><span class="badge text-danger mt-2">Rejected</span></td>
                                        @endif
                                        @if($order->order_status == '2')
                                           <td><span class="badge text-primary mt-2">Dispatched</span></td>
                                        @endif
                                      </tr>
                                    </table>
                        ...
                        <div class="col-12">
                            <div class="card shadow recent-sales">
                              ...
                              <div class="card-body">
                                ...
                                <table class="table table-bordered datatable dataTable-table" id="example">
                                  <thead>
                                    <tr>
                                  ...
                                  <tbody>
                                    @if(!empty($orderitems))
                                       @foreach($orderitems as $item)
                                          ...
                                          <td><img class="img-fluid" src="{{ asset('images/package') . '/' . $item->image }}" width="30%" height="10%"></td>
                                          <td><p>{{$item->name}}</p></td>
                                          <td><p>{{$item->qty}}</p></td>
                  ...
                  <tbody class="list"> 
                    ...
                    @if(!empty($order->image4))
                      <tr>
                        ...
                        <td class="orders-order">
                          <img id="image1" src="/images/package/{{!empty($order->image4) ? $order->image4 : 'undraw_profile.svg'}}" alt="your image" width="22%" height="100%"/>
                        </td>
                        <td class="orders-order">
      ...
      <div class="col-12">
         <div class="card shadow recent-sales">
                   <div class="card-body">
                                ...
                                <table class="table table-bordered datatable dataTable-table text-center">
                                      <tr>
                                        <td>Name</td>
                                        <td></td>
                                        <td>-</td>
